...
{
    private const string VIEW_URL = 'davidbel_ai_search/document/view';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        ...
        foreach ($dataSource['data']['items'] as &$item) {
            $documentId = (int) $item[DocumentInterface::DOCUMENT_ID];
            $item['actions']['view'] = [
                'href' => $this->backendUrl->getUrl(
                    self::VIEW_URL,
                    [DocumentInterface::DOCUMENT_ID => $documentId]
                ),
                'label' => __('View'),
            ];
        }
