...
class ConfigurationXmlTest extends TestCase
{
    ...
    public function testConfigurationMatchesMagentoSchema(string $fileName, string $schema): void
    {
        ...
        $path = dirname(__DIR__, 2) . '/etc/' . $fileName;
    ...
    {
        $configurationDirectory = dirname(__DIR__, 2) . '/etc/';
    ...
    public function testRegistersEmbeddingClientsInPool(): void
    {
        ...
        self::assertTrue(
            $dependencyInjection->load(dirname(__DIR__, 2) . '/etc/di.xml')
        );
    ...
    public function testRegistersSearchResultPageCacheTagPreprocessor(): void
    {
        ...
        self::assertTrue(
            $dependencyInjection->load(dirname(__DIR__, 2) . '/etc/frontend/di.xml')
        );
    ...
    public function testDefinesEmbeddingBacklogSchema(): void
    {
        ...
        self::assertTrue(
            $databaseSchema->load(dirname(__DIR__, 2) . '/etc/db_schema.xml')
        );
