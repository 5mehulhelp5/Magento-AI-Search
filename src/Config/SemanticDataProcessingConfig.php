...
class SemanticDataProcessingConfig
{
    private const string XML_PATH_DOCUMENT_PROCESSING_BATCH_SIZE =
        'davidbel_ai_search_semantic_data_processing/document_processing/batch_size';
    private const string XML_PATH_VECTOR_EMBEDDING_BATCH_SIZE =
        'davidbel_ai_search_semantic_data_processing/vector_embedding/batch_size';
    private const string XML_PATH_CONCURRENT_EMBEDDING_REQUESTS =
        'davidbel_ai_search_semantic_data_processing/vector_embedding/concurrent_requests';
    ...
    private const string XML_PATH_INDEXER_LOCK_TIMEOUT_SECONDS =
        'davidbel_ai_search_semantic_data_processing/indexer/lock_timeout_seconds';
    private const string XML_PATH_INDEXER_MINIMUM_SUCCESS_PERCENTAGE =
        'davidbel_ai_search_semantic_data_processing/indexer/minimum_success_percentage';
